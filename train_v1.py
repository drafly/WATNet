...
from dataloaders.dataloader_FiveK import EnhanceDataset_LOL
...
if __name__ == "__main__":
    ...
    ###
    train_dataset = EnhanceDataset_LOL(option.images_path, option.image_h, image_size_w=option.image_w)
    ...
    eval_dataset = EnhanceDataset_LOL(
