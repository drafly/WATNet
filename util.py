...
def calculate_psnr(img1, img2):
    ...
    # print("psnr time is: ",time.time()-start_time)
...
def ssim(img1, img2):
    ...
    # print("calculate ssim time!!!!!!!!!!!!!!!!!!")
    # print("ssim time is: ",time.time()-start_time)
...
def draw_picture(train_loss_path, save_name, title_name):
    ...
    plt.plot(x_train_loss, y_train_loss, linewidth=1, linestyle="solid", label=save_name)
    plt.legend()
...
def torchSSIM(tar_img, prd_img):
    return py_ssim(tar_img, prd_img, data_range=1.0, size_average=True)
